    ...
    <div className="w-full flex-col p-4 md:p-8 pt-8 md:pt-12 animate-fade-in pb-32 text-white">
      <div className="max-w-4xl mx-auto flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-2">
          <h1 className="text-3xl md:text-5xl font-black tracking-tight text-white">Series Settings</h1>
          <p className="text-white/50 text-base md:text-lg">Configure your TV streaming experience.</p>
        </div>
            ...
            <div className="p-6 bg-white/[0.02] border border-white/5 rounded-2xl flex flex-col gap-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex flex-col gap-1">
                  <span className="font-semibold text-white">Default Series Server</span>
                  <span className="text-sm text-white/50">Preferred source for TV streaming</span>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-col gap-1">
                  <span className="font-semibold text-white">Autoplay Next Episode</span>
                  <span className="text-sm text-white/50">Automatically start the next episode in a season</span>
                </div>
                <div className="w-12 h-6 bg-emerald-500 rounded-full relative cursor-pointer shadow-[0_0_15px_rgba(16,185,129,0.4)]">
            ...
            <div className="p-6 bg-white/[0.02] border border-white/5 rounded-2xl flex flex-col gap-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-sm text-white/50">Default language for Series CC</span>
                </div>
                <select className="bg-white/5 border border-white/10 rounded-xl px-4 py-2 text-white outline-none cursor-pointer">
